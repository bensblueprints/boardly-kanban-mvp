...
export default function ChatGPTConnection({onChange,ownerSubscription=false}){
 ...
 <div><h3 className="font-semibold text-lg">Use your ChatGPT account</h3><p className="text-sm text-zinc-300 mt-2">Connect the ChatGPT account you already use. No OpenAI API key or boredly AI usage card is needed. Your ChatGPT plan’s Codex access and usage limits apply.</p></div>
 <p className="text-xs text-zinc-400">Sign in on OpenAI’s website. boredly saves the connection privately for your account so AI can keep helping with your projects. You can disconnect here at any time. This connects AI access; it does not import your ChatGPT conversations.</p>
 ...
 <ol className="list-decimal pl-5 space-y-2 text-sm"><li>Open the OpenAI sign-in page and sign in with your ChatGPT account.</li><li>Enter this one-time code and approve the connection.</li><li>Return here. boredly will detect your sign-in automatically.</li></ol>
