...
export default function TailscaleConnection(){
 ...
 {started&&<p className="text-xs text-zinc-500">boredly device: {data.device_name}. Your network remains separate from other boredly accounts. Disconnecting immediately stops its device connections.</p>}
