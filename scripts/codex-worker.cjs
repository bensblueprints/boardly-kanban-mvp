...
async function request(route, data, method = 'POST') {
  ...
  const response = await fetch(origin + route, { method, signal: AbortSignal.timeout(route.endsWith('/inspect-image')?300000:route.includes('/github/')?180000:route.includes('/computeruse/')?100000:60000),
