const SCOPE_CATALOG = [
  { id: 'computers', name: 'Computer use', description: 'Assign computers from the account’s ComputerUse API and explicitly enable Work-agent viewing and control. The API key remains with the owner.' },
