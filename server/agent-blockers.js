function createAgentBlockers(db){
 ...
 function record(job,blocker,nextAction){
  ...
  db.prepare('INSERT INTO comments(card_id,author,body) VALUES (?,?,?)').run(card.id,'Boardly agent',`Blocker: ${blocker}\n\nNext action: ${nextAction}\n\nRun: ${job.id}`);
